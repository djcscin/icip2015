...
OBJECTFILES= \
	...
	${OBJECTDIR}/_ext/1553561446/sbbdt.o
...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ../../../exe/${CND_PLATFORM}-${CND_CONF}/sBBDT

../../../exe/${CND_PLATFORM}-${CND_CONF}/sBBDT: ${OBJECTFILES}
...
${OBJECTDIR}/_ext/1553561446/sbbdt.o: ../../../src/provisional/sbbdt.c 
	${MKDIR} -p ${OBJECTDIR}/_ext/1553561446
	${RM} "$@.d"
	$(COMPILE.c) -I../../../include -I../../../include/union_find -I../../../include/provisional -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/1553561446/sbbdt.o ../../../src/provisional/sbbdt.c
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ../../../exe/${CND_PLATFORM}-${CND_CONF}/sBBDT
